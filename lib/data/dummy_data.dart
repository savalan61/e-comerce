  ...
  static final List<ProductModel> products = [
    ...
    ProductModel(
      ...
      productAttributes: [
        ...
        ProductAttributeModel(name: 'Size', values: ['6-seater', '8-seater']),
      ],
      productType: ProductType.single,
    ),
    ProductModel(
      ...
      categoryId: '3',
      productAttributes: [
        ProductAttributeModel(name: 'Color', values: ['Navy', 'Black']),
    ...
    ProductModel(
      ...
      price: 150,
      isFeatured: true,
      thumbnail: TImages.productImage44,
      ...
      productAttributes: [
        ...
        ProductAttributeModel(name: 'Battery Life', values: ['20 hours', '30 hours']),
      ],
      productType: ProductType.single,
    ),
    ProductModel(
      ...
      categoryId: '6',
      productAttributes: [
        ProductAttributeModel(name: 'Color', values: ['White', 'Gray']),
    ...
    ProductModel(
      ...
      isFeatured: false,
      thumbnail: TImages.productImage70,
      description: 'Stylish luxury handbag for fashion lovers.',
      brand: BrandModel(
        id: '4',
      ...
      productAttributes: [
        ProductAttributeModel(name: 'Color', values: ['Black', 'Red']),
        ProductAttributeModel(name: 'Material', values: ['Leather', 'Synthetic']),
      ],
      productType: ProductType.single,
    ),
    ProductModel(
      ...
      isFeatured: false,
      thumbnail: TImages.productImage73,
      description: 'Convenient portable blender for smoothies.',
      brand: BrandModel(
        id: '5',
      ...
      categoryId: '2',
      productAttributes: [
        ProductAttributeModel(name: 'Color', values: ['Green', 'White']),
        ProductAttributeModel(name: 'Power', values: ['300W', '500W']),
      ],
      productType: ProductType.single,
    ),
    ProductModel(
      ...
      categoryId: '1',
      productAttributes: [
        ProductAttributeModel(name: 'Color', values: ['Purple', 'Blue']),
        ProductAttributeModel(name: 'Thickness', values: ['4mm', '6mm']),
      ],
      productType: ProductType.variable,
    ),
    ProductModel(
    ...
    ProductModel(
      ...
      categoryId: '3',
      productAttributes: [
        ProductAttributeModel(name: 'Color', values: ['Blue', 'White']),
        ProductAttributeModel(name: 'Size', values: ['M', 'L', 'XL']),
      ],
      productType: ProductType.single,
    ),
